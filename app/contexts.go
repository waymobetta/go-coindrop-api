...
// AssignErc721Context provides the erc721 assign action context.
type AssignErc721Context struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
...
// NewAssignErc721Context parses the incoming request URL and body, performs validations and creates the
// context used by the erc721 controller assign action.
func NewAssignErc721Context(ctx context.Context, r *http.Request, service *goa.Service) (*AssignErc721Context, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := AssignErc721Context{Context: ctx, ResponseData: resp, RequestData: req}
	return &rctx, err
}

// OK sends a HTTP response with status code 200.
func (ctx *AssignErc721Context) OK(r *Erc721) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.erc721+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *AssignErc721Context) BadRequest(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *AssignErc721Context) NotFound(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// Gone sends a HTTP response with status code 410.
func (ctx *AssignErc721Context) Gone(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 410, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *AssignErc721Context) InternalServerError(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// NewShowPublicContext parses the incoming request URL and body, performs validations and creates the
// context used by the public controller show action.
func NewShowPublicContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowPublicContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ShowPublicContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramRedditUsername := req.Params["redditUsername"]
	if len(paramRedditUsername) > 0 {
		rawRedditUsername := paramRedditUsername[0]
		rctx.RedditUsername = rawRedditUsername
	}
	return &rctx, err
}
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *ShowPublicContext) BadRequest(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *ShowPublicContext) NotFound(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// Gone sends a HTTP response with status code 410.
func (ctx *ShowPublicContext) Gone(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 410, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *ShowPublicContext) InternalServerError(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// DisplayTargetingContext provides the targeting display action context.
type DisplayTargetingContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	Project string
...
// NewDisplayTargetingContext parses the incoming request URL and body, performs validations and creates the
// context used by the targeting controller display action.
func NewDisplayTargetingContext(ctx context.Context, r *http.Request, service *goa.Service) (*DisplayTargetingContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := DisplayTargetingContext{Context: ctx, ResponseData: resp, RequestData: req}
...
// OK sends a HTTP response with status code 200.
func (ctx *DisplayTargetingContext) OK(r *Targeting) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.targeting+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *DisplayTargetingContext) BadRequest(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *DisplayTargetingContext) NotFound(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// Gone sends a HTTP response with status code 410.
func (ctx *DisplayTargetingContext) Gone(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 410, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *DisplayTargetingContext) InternalServerError(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// ListTargetingContext provides the targeting list action context.
type ListTargetingContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
}

// NewListTargetingContext parses the incoming request URL and body, performs validations and creates the
// context used by the targeting controller list action.
func NewListTargetingContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListTargetingContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ListTargetingContext{Context: ctx, ResponseData: resp, RequestData: req}
	return &rctx, err
}

// OK sends a HTTP response with status code 200.
func (ctx *ListTargetingContext) OK(r *Reddittargeting) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.reddittargeting+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *ListTargetingContext) BadRequest(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *ListTargetingContext) NotFound(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// Gone sends a HTTP response with status code 410.
func (ctx *ListTargetingContext) Gone(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 410, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *ListTargetingContext) InternalServerError(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// SetTargetingContext provides the targeting set action context.
type SetTargetingContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
...
// NewSetTargetingContext parses the incoming request URL and body, performs validations and creates the
// context used by the targeting controller set action.
func NewSetTargetingContext(ctx context.Context, r *http.Request, service *goa.Service) (*SetTargetingContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := SetTargetingContext{Context: ctx, ResponseData: resp, RequestData: req}
	return &rctx, err
}

// OK sends a HTTP response with status code 200.
func (ctx *SetTargetingContext) OK(resp []byte) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *SetTargetingContext) BadRequest(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *SetTargetingContext) NotFound(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// Gone sends a HTTP response with status code 410.
func (ctx *SetTargetingContext) Gone(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 410, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *SetTargetingContext) InternalServerError(r *StandardError) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/standard_error+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
