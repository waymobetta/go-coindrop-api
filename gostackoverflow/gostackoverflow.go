...
func GetProfileByUserID(u *coindropdb.User) (*coindropdb.User, error) {
	...
	for index := range aboutProfResStruct.Items {
		u.Info.StackOverflowData = coindropdb.StackOverflowData{
			...
			Accounts:          accounts,
			Communities: []coindropdb.Community{
				coindropdb.Community{
					Name:          "stackoverflow",
			...
			VerificationData: coindropverification.VerificationData{
...
func GetAssociatedAccounts(u *coindropdb.User) (*coindropdb.User, error) {
	...
	communityObj := coindropdb.Community{}
