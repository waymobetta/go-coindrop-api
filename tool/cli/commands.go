...
{
   "taskId": "Exercitationem dignissimos est dolores sequi cumque.",
   "userId": "Dolorum accusantium eos accusantium molestias."
}`,
...
{
   "cognitoAuthUserId": "Sit sed nobis."
}`,
	...
	command = &cobra.Command{
		Use:   "list",
		Short: `Get list of user tasks`,
	}
	tmp4 := new(ListTasksCommand)
	sub = &cobra.Command{
		Use:   `tasks ["/v1/tasks"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp11 := new(ShowVerifyredditCommand)
	sub = &cobra.Command{
	...
	tmp13 := new(UpdateRedditharvestCommand)
	sub = &cobra.Command{
...

{
   "completed": false
	...
	command.AddCommand(sub)
	tmp15 := new(UpdateVerifyredditCommand)
	sub = &cobra.Command{
		Use:   `verifyreddit ["/v1/social/reddit/userid/verify"]`,
		Short: ``,
		Long: `
