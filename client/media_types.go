...
// DecodeErc721lookup decodes the Erc721lookup instance encoded in resp body.
func (c *Client) DecodeErc721lookup(resp *http.Response) (*Erc721lookup, error) {
	var decoded Erc721lookup
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodePublicbadges decodes the Publicbadges instance encoded in resp body.
func (c *Client) DecodePublicbadges(resp *http.Response) (*Publicbadges, error) {
	var decoded Publicbadges
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
